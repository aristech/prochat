...
describe('components/signup/Signup', () => {
    ...
    it('should NOT show newsletter check box opt-in for self-hosted AND airgapped workspaces', async () => {
        ...
        expect(signupContainer).toHaveTextContent('Interested in receiving Prochat security, product, promotions, and company updates updates via newsletter?Sign up at https://progressnet.gr/.');
    });
    ...
    it('should show newsletter related opt-in or text for cloud', async () => {
        ...
        expect(signupContainer).toHaveTextContent('I would like to receive ProChat security updates via newsletter. By subscribing, I consent to receive emails from ProChat with product updates, promotions, and company news. I have read the Privacy Policy and understand that I can unsubscribe at any time');
    });
});
